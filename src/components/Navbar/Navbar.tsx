...
export default function Navbar(){
    ...
    return (
        <nav className={styles.navbar}>
            ...
            <i className={`fa-solid ${isCollapsed ? "fa-bars" : "fa-x"} ${styles['navbar-toggle']}`} onClick={toggleCollapsed}></i>
            <ul className={`${styles['navbar-list']} ${isCollapsed && styles.collapsed}`}>
                ...
                <NavLink to="/">
                    <img className={`${styles['navbar-img']} ${styles.bigDisplay}`} src={navImg} alt="home"/>
                </NavLink>
                <NavLink to="/catering">
